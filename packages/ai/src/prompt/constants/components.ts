...
COMPONENT RULES
- Prefer the catalog below. To use a component, install it into the project with its install URL: ${COMPONENT_REGISTRY_INSTALL_HINT}
...
CATALOG (curated components available to install):
${buildCatalog()}`;
