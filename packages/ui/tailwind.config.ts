        ...
        extend: {
            colors: {
                ...
                background: {
                    ...
                    weblab: 'hsl(var(--background-weblab))',
                    brand: {
                    ...
                    success: {
                        ...
                        secondary: 'hsl(var(--background-success-secondary))',
                    },
                    warning: {
                        DEFAULT: 'hsl(var(--background-warning))',
                        secondary: 'hsl(var(--background-warning-secondary))',
                    },
                    ...
                    bar: {
                        DEFAULT: 'hsl(var(--background-bar))',
                        active: 'hsl(var(--background-bar-active))',
                    },
                    'tab-strip': 'hsl(var(--background-tab-strip))',
                    'tab-active': 'hsl(var(--background-tab-active))',
                },
                foreground: {
                    DEFAULT: 'hsl(var(--foreground))',
                    weblab: 'hsl(var(--foreground-weblab))',
                ...
                border: {
                    ...
                    canvas: 'hsl(var(--border-canvas))',
                    bar: 'hsl(var(--border-bar))',
                    success: 'hsl(var(--border-success))',
                    warning: 'hsl(var(--border-warning))',
                    'tab-active': 'hsl(var(--border-tab-active))',
                    'tab-divider': 'hsl(var(--border-tab-divider))',
                },
                muted: {
