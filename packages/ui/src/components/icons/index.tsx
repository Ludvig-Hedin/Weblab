...
export const Icons = {
    ...
    // The Claude sunburst mark (distinct from the angular Anthropic "A" above).
    // Source: @lobehub/icons (MIT). Used for Anthropic/Claude models in pickers.
    ClaudeLogo: ({ className, ...props }: IconProps) => (
        <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
    ...
    Figma: ({ className, ...props }: IconProps) => (
        // Official Figma brand mark (5-colour). Uses fixed brand colours rather
        // than currentColor — it is a logo, not a UI glyph. viewBox is 2:3, so it
        // letterboxes (centred) inside a square icon slot.
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 200 300"
            className={className}
