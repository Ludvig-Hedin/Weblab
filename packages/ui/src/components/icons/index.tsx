...
export const Icons = {
    ...
    AnthropicLogo: ({ className, ...props }: IconProps) => (
    ...
    OpenAiLogo: ({ className, ...props }: IconProps) => (
        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
    ...
    KimiLogo: ({ className, ...props }: IconProps) => (
        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
    ...
    GeminiLogo: ({ className, ...props }: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 65 65"
        ...
        >
            ...
            <path
                ...
                fill="url(#weblab-gemini-grad)"
            />
        </svg>
    ),

    OllamaLogo: ({ className, ...props }: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="25"
    ...
    OpenCodeLogo: ({ className, ...props }: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="240"
            height="300"
    ...
    Pause: ({ className, ...props }: IconProps) => (
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        >
            <path
                ...
                fill="currentColor"
            />
            <path d="M9.5 8.5H10.75V15.5H9.5V8.5Z" fill="currentColor" />
            <path d="M13.25 8.5H14.5V15.5H13.25V8.5Z" fill="currentColor" />
        </svg>
    ),
