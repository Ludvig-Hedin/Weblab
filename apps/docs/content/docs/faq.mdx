...
Yes, Weblab is completely open-source and free to use. You can clone the repository from [GitHub](https://github.com/Ludvig-Hedin/Weblab) and run it locally.
...
You can report bugs or request features on our [GitHub Issues page](https://github.com/Ludvig-Hedin/Weblab/issues).
