...
For coding agents and contributors doing broad changes, the optional
`docs/agent-context/` pack contains a current repo map, development setup notes,
editor deep dive, data/API deep dive, and product/design context.
...
│   └── db/                        # Drizzle schema, mappers, defaults, seed, and DB client
│   
...
Old electron architecture doc. Still relevant, replace webview with iframe: https://github.com/Ludvig-Hedin/Weblab/wiki/Architecture
