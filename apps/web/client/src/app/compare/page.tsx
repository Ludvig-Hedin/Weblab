...
export default function CompareIndexPage() {
  return (
    <WebsiteLayout showFooter={true}>
      <section
        className="sr-only"
        aria-label="Compare Weblab to AI design tools"
      >
        <p>
          Compare {APP_NAME} to Lovable, Bolt, v0, Webflow, Framer, Replit,
          Claude Code, Emergent, Wix, one.com, and Onlook — pick the right tool
          for your team.
        </p>
      </section>
        ...
        <section className="bg-black py-40">
          <div className="mx-auto max-w-6xl px-8">
            ...
            <p className="text-foreground-secondary max-w-2xl text-lg md:text-xl">
              Most AI design tools generate new code from scratch. {APP_NAME}{" "}
              edits your real React components on a visual canvas and ships pull
              requests engineers can merge.
            </p>
            <div className="mt-12">
              <Button asChild>
            ...
            <ul className="grid gap-6 md:grid-cols-2">
              {competitors.map((c) => (
                <li key={c.slug}>
                  ...
                  >
                    <p className="text-foreground-tertiary mb-2 text-sm uppercase tracking-wide">
                      {c.tagline}
                    </p>
