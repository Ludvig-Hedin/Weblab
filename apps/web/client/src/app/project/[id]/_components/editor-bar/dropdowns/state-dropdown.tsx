    ...
    return (
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="start" className="mt-1 min-w-[120px] rounded-lg p-1">
                <DropdownMenuItem className="text-muted-foreground data-[highlighted]:bg-background-tertiary/10 border-border/0 data-[highlighted]:border-border data-[highlighted]:text-foreground text-small flex items-center rounded-md border px-2 py-1.5">
                    Default
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
