                    ...
                    <Tooltip key={optionValue}>
                        <TooltipTrigger asChild>
                            <ToggleGroupItem
                                value={optionValue}
                                aria-label={label}
                                className="text-foreground-tertiary data-[state=on]:bg-foreground-brand/15 data-[state=on]:text-foreground-brand hover:bg-foreground/5 hover:text-foreground-primary h-full w-7 shrink-0 rounded-[4px] transition-colors"
                            >
