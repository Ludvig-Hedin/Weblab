    ...
    return (
        <div className={cn('flex min-w-0 flex-col gap-1.5', className)}>
            <div className="flex min-w-0 items-center gap-1.5">
                ...
                <div className="border-input bg-foreground/5 flex h-[30px] shrink-0 items-center gap-0.5 rounded-[8px] border p-0.5 dark:border-white/[0.08] dark:bg-[rgb(50,50,50)]">
                    <button
                        type="button"
                ...
                <div className="flex min-w-0 flex-col gap-1">
                    ...
                    <div className="flex min-w-0 items-stretch gap-1">
                        {SIDES.map((side) => (
                            <span
                                key={side}
                                className="text-foreground-tertiary min-w-0 flex-1 text-center text-[10px] leading-none tracking-wider uppercase"
                            >
                                {SIDE_LABEL[side]}
                            </span>
                        ))}
