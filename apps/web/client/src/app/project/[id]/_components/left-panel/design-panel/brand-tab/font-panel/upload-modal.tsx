    ...
    ({ isOpen, onOpenChange, onUpload, isUploading = false }: UploadModalProps) => {
        ...
        return (
            <AlertDialog open={isOpen} onOpenChange={onOpenChange}>
                <AlertDialogContent className="bg-background-weblab/20 max-h-[80vh] max-w-2xl gap-0 p-0">
                    <div className="relative flex flex-col">
                        ...
                        <div className="mb-0 flex min-h-0 flex-1 flex-col px-6 pb-0">
                            <div
                                className="border-foreground/20 bg-foreground/5 mb-6 flex cursor-pointer flex-col items-center justify-center rounded-lg border border-dashed p-8"
                                onClick={() => fileInputRef.current?.click()}
                                onDrop={handleDrop}
                                onDragOver={handleDragOver}
                            >
                                <div className="bg-foreground/10 border-foreground/10 mb-4 flex h-10 w-10 items-center justify-center rounded-md border">
                                    <svg
