                        ...
                        >
                            <div className="flex max-w-xl flex-col gap-3">
                                ...
                                <div className="text-small flex flex-col gap-1.5 px-3 py-2 leading-snug tracking-[-0.005em]">
                                    Reading{' '}
                                    <code className="text-foreground-secondary">page.tsx</code> to
                                    understand the current theme setup, then I'll add a system-aware
                                    dark-mode toggle.
                                </div>

                                {/* Tool-call rows in three states */}
