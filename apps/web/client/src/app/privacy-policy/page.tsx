                ...
                <div className="mx-auto max-w-4xl px-8 py-16">
                    ...
                    <div className="prose prose-invert max-w-none">
                        ...
                        <p className="text-foreground-secondary mb-6">
                            At Weblab, we take your privacy seriously. Please read this Privacy
                        ...
                        <p className="text-foreground-secondary mb-6">
                            Remember that your use of Weblab's Services is at all times subject to
                        ...
                        <p className="text-foreground-secondary mb-6">
                            ...
                            changes by placing a notice on the Weblab website, by sending you an
                            ...
                            <li>
                                ...
                                <ul className="mt-2 list-disc pl-6">
                                    <li>
                                        ...
                                        information about Weblab or the Services.
                                    </li>
                                    <li>
                        ...
                        <p className="text-foreground-secondary mb-6">
                            ...
                            please contact us at contact@weblab.build.
                        </p>
