    ...
    return (
        <section id="subprocessors" className="scroll-mt-24">
            <div className="mx-auto w-full max-w-6xl px-4 py-24 sm:px-6 md:px-8 md:py-32">
                                ...
                                {rows.map((row, i) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-4">
                                                <span
                                                    className={`text-micro r inline-flex items-center rounded-full px-2.5 py-0.5 font-mono ${
                                                        REGION_TONE[region] ??
                ...
                <div className="text-foreground-tertiary text-small mt-6 flex flex-col gap-1">
                    <p>{t('note')}</p>
