...
export function ComponentsMockup() {
    return (
        <div className="bg-background-weblab/80 relative flex min-h-[400px] flex-row gap-8 overflow-hidden rounded-lg">
                                ...
                                {item.label === 'Chart' && (
                                    <div className="relative flex h-16 w-18 flex-col overflow-hidden rounded-xs bg-black p-0.5 select-none">
                                        ...
                                        <div className="relative flex flex-1 flex-col justify-end">
                                            ...
                                            >
                                                {[
                                                    8, 15, 6, 18, 13, 10, 17, 7, 19, 12, 5, 16, 14,
                                                    9, 18, 11, 8, 17, 6, 15, 12, 14, 10, 6, 7, 18,
                                                    13, 9, 1, 11, 17, 8, 14, 6, 19, 14, 14, 9, 20,
                                                    10, 13, 15, 9, 17, 8, 12, 14, 6, 18, 11,
                                                ].map((h, i) => (
                                                    <div
                                                        key={i}
