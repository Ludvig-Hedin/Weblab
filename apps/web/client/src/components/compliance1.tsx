            ...
            <div className="container">
                <div className="grid gap-9 lg:grid-cols-2">
                    <div className="flex flex-col gap-5">
                        ...
                        <h1 className="text-4xl font-medium text-balance lg:text-5xl">{heading}</h1>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                ...
                                <img
                                    ...
                                    className="absolute right-4 -bottom-7 size-24 text-slate-500 opacity-80 grayscale lg:right-8 lg:size-32 dark:text-slate-400 dark:invert"
                                />
                            </div>
                        ))}
                    </div>
