        ...
        <section className={cn('py-32', className)}>
            <div className="container">
                <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 text-center">
                    ...
                    <h3 className="max-w-3xl text-lg text-slate-500 md:text-xl dark:text-slate-400">
                        {description}
                    </h3>
                    ...
                    <img
                        src={image}
                        alt="placeholder"
                        className="mt-4 mb-8 aspect-video w-full rounded-lg border border-slate-200 object-cover dark:border-slate-800"
                    />
                </div>
            </div>
            <div className="container">
                <div className="prose dark:prose-invert mx-auto max-w-3xl">
                    ...
                    <p className="mt-2 text-lg text-slate-500 dark:text-slate-400">
                        ...
                        unfolded about a king who decided to tax the very essence of joy itself -
                        jokes and jest.
                    </p>
