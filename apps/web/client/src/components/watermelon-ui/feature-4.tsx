    ...
    return (
        <section className="flex w-full flex-col items-center justify-center px-6 py-16">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl text-center">
                Get clarity on performance, uncover patterns, and take action with insights that
                actually move things forward.
            </p>

            <div className="mt-12 grid w-full max-w-6xl items-start gap-8 md:grid-cols-3">
                {/* Activity stream */}
                <div className="flex flex-col gap-5">
                    <div className="bg-background border-border/60 flex min-h-[320px] flex-col justify-between gap-4 rounded-2xl border p-4 shadow-sm">
                    ...
                    <div className="px-1">
                        <h3 className="text-foreground text-xl font-semibold">Activity stream</h3>
                        <p className="text-muted-foreground mt-1.5 text-sm/6">
                            Track live system activity and event flow in real time, helping you spot
                            spikes and performance changes instantly.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="px-1">
                        <h3 className="text-foreground text-xl font-semibold">User segments</h3>
                        <p className="text-muted-foreground mt-1.5 text-sm/6">
                            Understand how different user groups behave and interact, so you can
                            identify patterns and high-impact segments quickly.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="px-1">
                        <h3 className="text-foreground text-xl font-semibold">Momentum score</h3>
                        <p className="text-muted-foreground mt-1.5 text-sm/6">
                            Monitor growth across key metrics with a unified score, revealing trends
                            and momentum shifts at a glance.
                        </p>
                    </div>
                </div>
            </div>
