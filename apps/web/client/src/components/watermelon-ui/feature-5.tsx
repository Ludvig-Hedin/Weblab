...
import { HiMiniClock, HiMiniExclamationTriangle, HiMiniSquares2X2 } from 'react-icons/hi2';
            ...
            <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 lg:grid-cols-2">
                <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground max-w-lg">
                        Coordinate actions, automate decisions, and keep everything moving without
                        constant manual input or switching between tools.
                    </p>
                    ...
                    <Button className="bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/90 rounded-md border-transparent px-6 shadow-[0_4px_12px_rgba(0,0,0,0.08)] dark:border-transparent">
                        Start building
                    </Button>
                </div>
                    ...
                    <div className="relative h-[380px] w-full max-w-md">
                        <Card className="bg-background/80 dark:bg-card/80 ring-border/50 border-border/50 absolute top-0 left-0 w-[260px] rounded-lg border p-0 shadow-[0_10px_30px_rgba(0,0,0,0.12)] backdrop-blur-md">
                            <CardContent className="space-y-2 p-4">
                                <div className="text-muted-foreground text-xs">Incoming Flow</div>
                                ...
                                <div className="flex gap-2 text-[10px]">
                                    ...
                                    <span className="bg-muted rounded-md px-2 py-0.5">Trigger</span>
                                </div>
                        ...
                        <Card className="bg-background/90 dark:bg-card/80 ring-border/50 border-border/50 absolute top-28 right-0 z-50 w-[240px] rounded-lg border p-0 shadow-[0_12px_40px_rgba(0,0,0,0.18)] backdrop-blur-md">
                            <CardContent className="space-y-3 p-4">
                                <div className="text-muted-foreground text-xs">Decision Layer</div>
