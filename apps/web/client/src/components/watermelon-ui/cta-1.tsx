...
export function Cta1({
    ...
    return (
        <section className="w-full max-w-6xl py-12 md:py-16">
                    ...
                    <div className="mt-2 flex w-full shrink-0 justify-center md:mt-0 md:w-auto">
                        {buttonLink ? (
                            <Button
                                asChild
                                size="lg"
                                className="bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/90 h-12 w-full border-transparent px-8 text-base shadow-[0_8px_20px_rgba(0,0,0,0.12)] md:w-auto dark:border-transparent"
                            >
                                <a href={buttonLink}>
                                    {buttonText}
                                    {buttonIcon && (
