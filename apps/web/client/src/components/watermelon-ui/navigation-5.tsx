import { ArrowUpRight, Command, Cpu, GitBranch, Layers, Menu, Terminal, User } from 'lucide-react';
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm tracking-tight text-neutral-600 dark:text-neutral-400">
                                                            Join our engineers for a live teardown
                                                            of the new Compute Engine architecture.
                                                        </p>
                                                    </div>
