...
export function Hero9({
    ...
    return (
        <section className="relative isolate min-h-screen w-full overflow-hidden bg-sky-300 font-sans text-slate-950 antialiased">
            <motion.div
            ...
            <div className="relative z-10 mx-auto flex min-h-[760px] w-full max-w-[1440px] flex-col px-5 py-4 sm:min-h-screen sm:px-9 lg:px-[58px]">
                ...
                >
                    ...
                    >
                        {logo ?? <LogoIcon className="size-8 text-slate-950" />}
