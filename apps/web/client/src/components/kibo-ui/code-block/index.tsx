...
export const CodeBlockFilename = ({
    ...
    return (
        <div
            className="flex items-center gap-2 bg-slate-100 px-4 py-1.5 text-xs text-slate-500 dark:bg-slate-800 dark:text-slate-400"
            {...props}
        >
...
export const CodeBlockSelectTrigger = ({ className, ...props }: CodeBlockSelectTriggerProps) => (
    <SelectTrigger
        className={cn(
            'w-fit border-none text-xs text-slate-500 shadow-none dark:text-slate-400',
            className,
        )}
        {...props}
    />
...
export const CodeBlockCopyButton = ({
    ...
    return (
        <Button
            ...
            {...props}
        >
            {children ?? <Icon className="text-slate-500 dark:text-slate-400" size={14} />}
        </Button>
    );
};
