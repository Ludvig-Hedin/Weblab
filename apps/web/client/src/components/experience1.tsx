  ...
  experience = [
    {
      ...
      description:
        "Leading development of scalable web applications using React, TypeScript, and Node.js. Mentoring junior developers implementing best practices.",
      company: "Google",
    ...
    },
    {
      ...
      description:
        "Built and maintained multiple client websites e-commerce platforms. Collaborated with design teams to implement pixel-perfect UI/UX designs.",
      company: "Microsoft",
    ...
    },
    {
      ...
      description:
        "Assisted in building web applications and learning modern development practices. Contributed to team projects code reviews.",
      company: "Netflix",
          ...
          {experience.map((exp, index) => (
            ...
            >
              ...
              <div className="lg:w-1/3">
                ...
                <p className="text-slate-950/50 dark:text-slate-50/50">{exp.description}</p>
              </div>
